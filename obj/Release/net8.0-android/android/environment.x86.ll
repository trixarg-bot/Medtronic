...
@dso_cache = dso_local local_unnamed_addr global [552 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 255125687, ; hash 0xf34e8b7, from name: Plugin.BLE.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 273568582, ; hash 0x104e5346, from name: Plugin.BLE
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.BLE.dll.so
		ptr null; void* handle (0x0)
	}, ; 35
	...
	%struct.DSOCacheEntry {
		i64 802021901, ; hash 0x2fcde20d, from name: aot-MaterialColorUtilities.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1137014120, ; hash 0x43c57568, from name: libaot-Material.Components.Maui
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1358872742, ; hash 0x50fec0a6, from name: aot-Material.Components.Maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Material.Components.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 163
	...
	%struct.DSOCacheEntry {
		i64 1616730037, ; hash 0x605d57b5, from name: MaterialColorUtilities
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MaterialColorUtilities.dll.so
		ptr null; void* handle (0x0)
	}, ; 197
	...
	%struct.DSOCacheEntry {
		i64 1665048963, ; hash 0x633ea183, from name: aot-Material.Components.Maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Material.Components.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 206
	...
	%struct.DSOCacheEntry {
		i64 1684094892, ; hash 0x64613fac, from name: aot-Medtronic
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1798075748, ; hash 0x6b2c7564, from name: Medtronic.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Medtronic.dll.so
		ptr null; void* handle (0x0)
	}, ; 223
	...
	%struct.DSOCacheEntry {
		i64 1974202329, ; hash 0x75abefd9, from name: MaterialColorUtilities.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MaterialColorUtilities.dll.so
		ptr null; void* handle (0x0)
	}, ; 248
	...
	%struct.DSOCacheEntry {
		i64 2019985919, ; hash 0x786689ff, from name: libaot-Medtronic
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Medtronic.dll.so
		ptr null; void* handle (0x0)
	}, ; 253
	...
	%struct.DSOCacheEntry {
		i64 2124815563, ; hash 0x7ea61ccb, from name: libaot-MaterialColorUtilities
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MaterialColorUtilities.dll.so
		ptr null; void* handle (0x0)
	}, ; 268
	...
	%struct.DSOCacheEntry {
		i64 2321065278, ; hash 0x8a58a53e, from name: aot-Medtronic.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Medtronic.dll.so
		ptr null; void* handle (0x0)
	}, ; 295
	...
	%struct.DSOCacheEntry {
		i64 2338448891, ; hash 0x8b61e5fb, from name: libaot-Plugin.BLE
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.BLE.dll.so
		ptr null; void* handle (0x0)
	}, ; 297
	...
	%struct.DSOCacheEntry {
		i64 2364551742, ; hash 0x8cf0323e, from name: libaot-Medtronic.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Medtronic.dll.so
		ptr null; void* handle (0x0)
	}, ; 301
	...
	%struct.DSOCacheEntry {
		i64 2433724974, ; hash 0x910fb22e, from name: libaot-Material.Components.Maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Material.Components.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 311
	...
	%struct.DSOCacheEntry {
		i64 2665209065, ; hash 0x9edbdce9, from name: Material.Components.Maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Material.Components.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 343
	...
	%struct.DSOCacheEntry {
		i64 2952168348, ; hash 0xaff6839c, from name: Medtronic
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Medtronic.dll.so
		ptr null; void* handle (0x0)
	}, ; 383
	...
	%struct.DSOCacheEntry {
		i64 3024415471, ; hash 0xb444eaef, from name: aot-Plugin.BLE.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.BLE.dll.so
		ptr null; void* handle (0x0)
	}, ; 396
	...
	%struct.DSOCacheEntry {
		i64 3192315464, ; hash 0xbe46de48, from name: aot-MaterialColorUtilities
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MaterialColorUtilities.dll.so
		ptr null; void* handle (0x0)
	}, ; 420
	...
	%struct.DSOCacheEntry {
		i64 3502494312, ; hash 0xd0c3d268, from name: libaot-Plugin.BLE.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.BLE.dll.so
		ptr null; void* handle (0x0)
	}, ; 452
	...
	%struct.DSOCacheEntry {
		i64 3602190383, ; hash 0xd6b5102f, from name: Material.Components.Maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Material.Components.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 465
	%struct.DSOCacheEntry {
		i64 3604555452, ; hash 0xd6d926bc, from name: aot-Plugin.BLE
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.BLE.dll.so
		ptr null; void* handle (0x0)
	}, ; 466
	...
	%struct.DSOCacheEntry {
		i64 3624994299, ; hash 0xd81105fb, from name: libaot-MaterialColorUtilities.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MaterialColorUtilities.dll.so
		ptr null; void* handle (0x0)
	}, ; 470
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [122 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
